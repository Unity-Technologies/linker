...
//            if (x.Name != y.Name && comparisonMode == MethodComparisonMode.IgnoreExplicitVsNormalInterfaceDifferences)
//            {
//                if (xResolved.IsExplicitInterfaceImplementation() && yResolved.IsExplicitInterfaceImplementation())
//                {
//                    return false;
//                }
//
//                if (xResolved.IsExplicitInterfaceImplementation() || yResolved.IsExplicitInterfaceImplementation())
//                {
//                    var xMethodForCompare = xResolved.IsExplicitInterfaceImplementation() ? xResolved.Overrides.First() : xResolved;
//                    var yMethodForCompare = yResolved.IsExplicitInterfaceImplementation() ? yResolved.Overrides.First() : yResolved;
//
//                    if (xMethodForCompare.Name != yMethodForCompare.Name)
//                        return false;
//
//                    if (!AreSignaturesEqual(xMethodForCompare, yMethodForCompare, TypeComparisonMode.SignatureOnlyLoose2))
//                        return false;
//                }
//                else
//                    return false;
